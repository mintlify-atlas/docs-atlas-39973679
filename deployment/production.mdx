...
El único valor que necesitas configurar antes de desplegar es el **número de teléfono de WhatsApp** al que se envían los pedidos. Este número está definido directamente en el código fuente:

```jsx
// src/App.jsx
const WHATSAPP_NUMBER = "569XXXXXXXX"; // Reemplaza con el número real
```
